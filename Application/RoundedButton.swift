...
class RoundedButton: UIButton
{
    ...
    func initializeWith(buttonTitle: String?, isEnabled: Bool, mainColor: UIColor, opposingColor: UIColor, preferredTarget: Selector?, withFontSize: CGFloat?, withAlpha: CGFloat)
    {
        ...
        UIView.animate(withDuration: 0.5, delay: 0.5, options: .curveEaseOut, animations: {
            ...
            else { self.setTitle(self.titleLabel!.text!.uppercased(), for: .normal) }
            ...
            else { self.titleLabel!.font = UIFont(name: "HelveticaNeue-Medium", size: 15) }
    ...
    {
        addTarget(lastInitializedController, action: withSelector, for: .touchUpInside)
    }
