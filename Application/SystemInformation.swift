...
{
    public static var deviceName: String { return try! informationString(withLevels: CTL_KERN, KERN_HOSTNAME) }
    ...
    public static var activeCpus: Int64 { return try! informationInteger(withLevels: CTL_HW, HW_AVAILCPU) }
    
    public static var kernelVersion: String { return try! informationString(withLevels: CTL_KERN, KERN_VERSION) }
    
    public static var operatingSystemRelease: String { return try! informationString(withLevels: CTL_KERN, KERN_OSRELEASE) }
    
    public static var operatingSystemRevision: Int64 { return try! informationInteger(withLevels: CTL_KERN, KERN_OSREV) }
    
    public static var operatingSystemType: String { return try! informationString(withLevels: CTL_KERN, KERN_OSTYPE) }
    
    public static var operatingSystemVersion: String { return try! informationString(withLevels: CTL_KERN, KERN_OSVERSION) }
}
